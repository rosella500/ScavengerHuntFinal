...
import os, pygame, json, csv,time
...
#        self.subtitles = text
#        length = text.__len__()
#        subArray =self.subtitles.split()
#
#    def renderSubtitle(self,screen,text):
#                font = pygame.font.Font(None,40)
#                font_surface = font.render(self.text,True,pygame.Color("white"))
#                screen.blit(font_surface,(100,400))
#                time.sleep(5)
#                screen.flip()
...
def main():
    ...
    while not modes.quitting():
        ...
        inventory.renderInventory(screen,room)
